...
public final class TransporterLoader implements PluginLoader {
  @Override
  public void classloader(final @NotNull PluginClasspathBuilder classpathBuilder) {
    final var resolver = new MavenLibraryResolver();
    resolver.addRepository(new RemoteRepository.Builder("triumph-team", "default", "https://repo.triumphteam.dev/snapshots/").build());
